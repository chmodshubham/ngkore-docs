...
![OAI O1 Adapter Architecture](../images/oai/oai-o1-adapter.png)
...
> **Note:** You can get the value of `<VES_SVC_PORT>` from the [ngkore/OSC-OAM](https://github.com/ngkore/OSC-OAM?tab=readme-ov-file#exposing-ves-collector-for-oai-o1-adapter).
